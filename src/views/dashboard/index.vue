  ...
  <div class="dashboard-container">
    ...
    <el-card class="header-card">
      <div>
        <div class="fl headL">
          <div class="headImg">
            <img :src="stallPhoto" v-imageerror='defaultImg'>
          </div>
    ...
    <el-dialog :visible='showDialog' title="离职申请" @close='btnCancel'>
      <!-- 表单内容 -->
      <el-form ref="ruleFrom" label-width="120px" :model="ruleForm" :rules="rules">
        <el-form-item prop="exceptTime" label="期望离职时间">
        ...
        <el-form-item prop="reason"  label="离职原因">
          <el-input v-model="ruleForm.reason" style="width: 70%" placeholder="请输入原因" type="textarea" :rows="3"/>
        </el-form-item>
      </el-form>
      <!-- 确认和取消 -->
...
export default {
  ...
  methods:{
    btnOk() {
      // 校验表单
      // this.$refs.ruleFrom.validate().then(() => {})
